...
forecast_arima_germany <- arima_germany %>% forecast(h = 13) %>% hilo(90)
```
...
forecast_table_germany_a <- forecast_table_germany_a %>% select(Forecast_Values.Date,Forecast_Values..mean, Forecast_Values.90.) 
...
# Forecasting using the models
forecast_ets_italy <- ets_italy %>% forecast(h = 13) %>% hilo(90)
```
...
forecast_table_italy_e <- forecast_table_italy_e %>% select(Forecast_Values.Date,Forecast_Values..mean, Forecast_Values.90.)
...
# Forecasting using the models
forecast_ets_total <- ets_total %>% forecast(h = 13) %>% hilo(90)
```
...
forecast_table_total_e <- forecast_table_total_e %>% select(Forecast_Values.Date,Forecast_Values..mean, Forecast_Values.90.)
