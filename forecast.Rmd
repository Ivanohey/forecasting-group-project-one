...
#Rounding all values to 0 significant figures becasue at the moment they have 4 decimals each...
final_fc$PF <- round(final_fc$PF)
final_fc$CI <- round(final_fc$CI)

#Removing all non-negative values from the CI column and replacing them by 0. 
final_fc$CI[final_fc$CI < 0] <- 0
