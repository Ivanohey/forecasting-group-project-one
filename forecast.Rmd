...
For Lichtenstein, since we logged the data to make the forecasts earlier, we have to use its inverse function (exponent) to bring the values back to their original magnitude. 
...
#  mutate(
#    Point.Forecast = ifelse(Country == "Lichtenstein", exp(Point.Forecast), Point.Forecast),
#    Lower.Interval = ifelse(Country == "Lichtenstein", exp(Lower.Interval), Lower.Interval),
#    Upper.Interval = ifelse(Country == "Lichtenstein", exp(Upper.Interval), Upper.Interval)
# )
