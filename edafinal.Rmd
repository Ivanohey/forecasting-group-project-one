...
- URGENT: FIX LICHTENSTEIN + add it to final table (Ok)
--> adjust in forecast the CI
...
Investigating the stationarity for different country is necessary before applying any models. We have run the Unit Root Test which is a statistical test that checks for the presence of a unit root in a time series, which is an indication of non-stationarity.
