...
forecast_table_italy <- data.frame(Model = c("ETS (ANA)", "ETS (AAA)"),
                              Forecast_Values = c(forecast_ets_italy_ANA, forecast_ets_italy_AAA))

forecast_table_italy <- forecast_table_italy %>% select(Forecast_Values..mean,Forecast_Values..mean.1)

colnames(forecast_table_italy)[1] <- "Italy_ets_AAA"
colnames(forecast_table_italy)[2] <- "Italy_ets_ANA"
