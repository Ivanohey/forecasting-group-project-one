...
As a result, the ARIMA model is selected to forecast the electricity demand in Italy and ETS model is selected to forecast in Germany, Austria and France. Finally, Snaive is selected to forecast in Lichtenstein.
