...
ETS could be great models based on a trade off between forecasting error and model complexity. ETS model has the second lowest RMSE and MAE which makes him a good candidate. In order to select a model, we can analyse residuals of those models
