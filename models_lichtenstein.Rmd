...
forecast_ets_Licht <- ets_Licht %>% forecast(h = 13)
...
forecast_ets_Licht %>% autoplot(Lichtenstein_after_2008) +
...
forecast_table_Lichtenstein_ets <- forecast_table_Lichtenstein_ets %>% select(Forecast_Values..mean)

colnames(forecast_table_Lichtenstein_ets)[1] <- "Lichtenstein_ets"
...
# forecast_pw_Licht$.mean <- ifelse(forecast_pw_Licht$.mean < 0, 0, forecast_pw_Licht$.mean)
# 
# 
# #Checking the residuals before forecasting
...
# 
# # Graphing the forecast
# forecast_pw_Licht %>% autoplot(Lichtenstein_after_2008) +
#   labs(title = "piecewise Forecast for Lichtenstein")
# 
# #Extracting the forecasted values
