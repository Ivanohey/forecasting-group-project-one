...
ggplot() + 
  ...
  annotate("text", x = 2024, y = forecast_sarima_france$pred[1], label = "Forecast", color = "red", size = 4) +
  annotate("text", x = 2024, y = forecast_sarima_france$pred[1] + 30, label = "95% Confidence Interval", color = "orange", size = 4)
