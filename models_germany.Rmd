...
Residuals analysis is also will be plotted to see how well the model captures the dynamics in data. Good models' residuals should be stationary (white noise) and have no patterns. 

We can see strong seasonality and trend in data from decomposition analysis, so we tested ARIMA, ETS, and Seasonal NAIVE models as we assume these models can handle these types of data the best. 

Lichtenstei Analysis will be described separately.
...
According to the accuracy table RMSE, MAE and other indicators, ARIMA has the lowest values on the test data. 
